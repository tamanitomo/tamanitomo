...
def cmd_pin(args):
    ...
    if getattr(args, "clear", False):
        ...
        print(
            f"Workspace remote PIN cleared. Remote access is now open to your local network without a PIN."
        )
        return 0
    ...
    if c.remote_pin:
        ...
        print(
            f"No workspace remote PIN configured. Remote access is open on your local network."
        )
