...
def mapping_for(c,persona:str='warm',style:str='none',relationship:str='',
    ...
    return {**commands,
        ...
        # Kept as tokens so templates read naturally, but always singular: the
        # kit has no plural pronoun set to disagree with.
        'BE':'is','DOES':'does','HAS':'has','ADDRESSES':'addresses',
        ...
        'RELATIONSHIP':relationship or iv.get('boundary') or boundary_text(c.boundary),
        'APPEARANCE':appearance or DEFAULT_APPEARANCE,
        'BOUNDARY':boundary or iv.get('boundary') or boundary_text(c.boundary),
        ...
        'BOUNDARY_ONELINE':boundary_text(c.boundary),
