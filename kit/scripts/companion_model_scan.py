...
FAMILY_HINTS = [
    ('illustrious', 'Illustrious'), ('noob', 'NoobAI'), ('pony', 'Pony'),
    ('animagine', 'Animagine'), ('flux', 'Flux'), ('sdxl', 'SDXL'),
    ('xl_base', 'SDXL'), ('stable-diffusion-xl', 'SDXL'), ('sd_xl', 'SDXL'),
    ('v1-5', 'SD 1.5'), ('sd15', 'SD 1.5'), ('stable-diffusion-v1', 'SD 1.5'),
]
...
def describe(path):
    ...
    for key in ('ss_base_model_version', 'modelspec.architecture',
                'ss_sd_model_name', 'ss_base_model', 'ss_pretrained_model_name_or_path'):
