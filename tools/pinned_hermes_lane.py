...
REQUIRED_CASES = tuple(f'tests.test_phase1b_c1_pinned.{name}' for name in (
    ...
    'PinnedHttp::test_http_fresh_turn_links_reads_and_replays',
    'PinnedHttp::test_http_dropped_stream_note_is_excluded_from_reads',
    'PinnedHttp::test_http_owner_text_equal_to_the_note_stays_owner_speech',
    'PinnedHttp::test_http_note_without_provenance_reads_as_recorded',
